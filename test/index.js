...
const reduce = require('../solution')(global.Homework);

const asyncArray = new global.Homework.AsyncArray([1, 2, 3, 4]);
const reducerSum = (acc, curr, i, src, cb) => global.Homework.add(acc, curr, cb);

reduce(asyncArray, reducerSum, 0, (res) => {
  console.log(res === 10 ? 'success' : 'fail');
});
